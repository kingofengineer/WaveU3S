...
from .build_tr_model import build_tr_model


class nnUNetTrainer(object):
    def __init__(self, plans: dict, configuration: str, fold: int, model: str,dataset_json: dict, unpack_dataset: bool = True,
        ...
        #！modify 
        #self.configuration_manager.patch_size = [96,192,192]
...
#! modifying here!
            ...
            self.network = build_tr_model(self.model_name, 1, 14)
...
#        loss = DeepSupervisionWrapper(loss, weights)
    ...
    def get_plain_dataloaders(self, initial_patch_size: Tuple[int, ...], dim: int):
        ...
        if dim == 2:
            ...
            print('patch_size',self.configuration_manager.patch_size)
            print('initial_patch_size',initial_patch_size)
